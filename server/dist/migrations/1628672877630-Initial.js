...
exports.Initial1628672877630 = void 0;
class Initial1628672877630 {
    constructor() {
        this.name = "Initial1628672877630";
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "post" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "creatorId" integer NOT NULL, "points" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club_event" ("clubId" integer NOT NULL, "eventId" integer NOT NULL, CONSTRAINT "PK_48146b5adf3a6de0f807ae56d08" PRIMARY KEY ("clubId", "eventId"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "event" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "location" character varying NOT NULL, "datetime" TIMESTAMP NOT NULL, "hostId" integer NOT NULL, "points" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club_follower" ("clubId" integer NOT NULL, "followerId" integer NOT NULL, CONSTRAINT "PK_7381c8401784d62f2591649f097" PRIMARY KEY ("clubId", "followerId"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club_member" ("clubId" integer NOT NULL, "memberId" integer NOT NULL, CONSTRAINT "PK_b8453131335a055cabe58490d39" PRIMARY KEY ("clubId", "memberId"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "event_attendee" ("eventId" integer NOT NULL, "attendeeId" integer NOT NULL, CONSTRAINT "PK_276a2ab1a71e3db913b6555de8a" PRIMARY KEY ("eventId", "attendeeId"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club_admin" ("clubId" integer NOT NULL, "adminId" integer NOT NULL, CONSTRAINT "PK_2ce91b5a985ef1448f5e73777e6" PRIMARY KEY ("clubId", "adminId"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_79098e276529e2f823ab6379e8f" UNIQUE ("name"), CONSTRAINT "UQ_3276cadeca232b6a6f4983c9652" UNIQUE ("email"), CONSTRAINT "PK_79282481e036a6e0b180afa38aa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "sport" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_6a16e1d83cb581484036cee92bf" UNIQUE ("name"), CONSTRAINT "PK_c67275331afac347120a1032825" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "club_sport" ("clubId" integer NOT NULL, "sportId" integer NOT NULL, CONSTRAINT "PK_0f2059c08f832b6b22920a57467" PRIMARY KEY ("clubId", "sportId"))`);
...
exports.Initial1628672877630 = Initial1628672877630;
//# sourceMappingURL=1628672877630-Initial.js.map