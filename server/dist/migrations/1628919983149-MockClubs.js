...
exports.MockClubs1628919983149 = void 0;
class MockClubs1628919983149 {
    async up(queryRunner) {
        await queryRunner.query(`insert into "user" ("id", "username", "email", "password") values (995, 'brock', 'fwillcocks0@networkadvertising.org', '$2a$10$ZE9qfXAvoxPUwL4lm4YpuuoXBPL2ZnO53mY0Nib.Z0QBKONrCakX.');
        ...
        await queryRunner.query(`insert into "club" ("id", "name", "email", "phoneNumber", "description") values (995, 'Eayo', 'hgetsham0@nytimes.com', '5491433760', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.
