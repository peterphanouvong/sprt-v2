...
export type DetailedEventFragment = {
  ...
  club?: Maybe<{
    ...
    admins: Array<{
      ...
      email: string;
      events?: Maybe<
        Array<{ __typename?: "Event"; id: number; title: string }>
      >;
      followingClubs?: Maybe<
  ...
  host: {
    ...
    username: string;
    email: string;
    events?: Maybe<Array<{ __typename?: "Event"; id: number; title: string }>>;
    followingClubs?: Maybe<
      Array<{ __typename?: "Club"; id: number; name: string; email: string }>
    >;
    adminClubs?: Maybe<
...
export type AddRequestedMemberMutation = {
  __typename?: "Mutation";
  addRequestedMember: boolean;
};
...
export type FollowClubMutation = {
  __typename?: "Mutation";
  followClub: boolean;
};
...
export type UnfollowClubMutation = {
  __typename?: "Mutation";
  unfollowClub: boolean;
};
...
export type PublicityTypesQuery = {
  __typename?: "Query";
...
export function useAddAttendeeMutation() {
  return Urql.useMutation<AddAttendeeMutation, AddAttendeeMutationVariables>(
    AddAttendeeDocument
  );
}
...
export function useAddRequestedMemberMutation() {
  return Urql.useMutation<
    AddRequestedMemberMutation,
    AddRequestedMemberMutationVariables
  >(AddRequestedMemberDocument);
}
...
export function useCreateClubMutation() {
  return Urql.useMutation<CreateClubMutation, CreateClubMutationVariables>(
    CreateClubDocument
  );
}
...
export function useDeleteClubMutation() {
  return Urql.useMutation<DeleteClubMutation, DeleteClubMutationVariables>(
    DeleteClubDocument
  );
}
...
export function useFollowClubMutation() {
  return Urql.useMutation<FollowClubMutation, FollowClubMutationVariables>(
    FollowClubDocument
  );
}
...
export function useUnfollowClubMutation() {
  return Urql.useMutation<UnfollowClubMutation, UnfollowClubMutationVariables>(
...
export function useUpdateClubMutation() {
  return Urql.useMutation<UpdateClubMutation, UpdateClubMutationVariables>(
    UpdateClubDocument
  );
}
...
export function useUpdateEventMutation() {
  return Urql.useMutation<UpdateEventMutation, UpdateEventMutationVariables>(
    UpdateEventDocument
  );
}
...
export function useClubsQuery(
  options: Omit<Urql.UseQueryArgs<ClubsQueryVariables>, "query"> = {}
) {
...
export function useMyFeedQuery(
  options: Omit<Urql.UseQueryArgs<MyFeedQueryVariables>, "query"> = {}
) {
...
export function usePublicityTypesQuery(
  options: Omit<Urql.UseQueryArgs<PublicityTypesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<PublicityTypesQuery>({
    query: PublicityTypesDocument,
    ...options,
  });
}
